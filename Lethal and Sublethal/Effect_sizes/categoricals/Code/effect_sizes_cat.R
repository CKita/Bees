...
#Now, let's use the compute.es function to calculate the Hedge's g value
#from the statistic F reported in the paper C0142.
...
#Combine the data from "escalc" and "fes" functions.
str(effect_sizes)
str(pronto)
...
#Save 
write.csv(effects_prontos, "../Data/effect_sizes_cat.csv", row.names = F)
